...
@WebService(endpointInterface = "ba.kmzs.cxf.AdminConfig")
@Addressing 
public class AdminConfigImpl implements AdminConfig {
    @WebMethod(operationName = "getServerTime", action="getServerTime")
	...
	@WebMethod(operationName = "getAdminToken", action="getAdminToken")
